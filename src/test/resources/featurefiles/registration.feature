...
#18. Verify that 'ACCOUNT DELETED!' is visible and click 'Continue' button
  ...
  Scenario: User should register successfully
    ...
    And I send name "Himanshu" and email "himanshu" to signup
    And I click on button "Signup"
    Then I should see text "ENTER ACCOUNT INFORMATION"
    And I fill all details in signup page "Mr" "Himanshu324" "19" "March" "1994" "Himanshu" "Patel" "Jawahar Nagar" "Goregaon" "India" "Maharashtra" "Mumbai" "400069" "09695379546"
    ...
    Then I should see the text "Logged in as " "Himanshu"
  ...
  Scenario: User should see error message while register with existing email
    ...
    When I click on header menu option "Signup / Login"
    Then I should see the login page text "New User Signup!"
    And I send name "Himanshu" to name field in signup
    And I send email "himanshu324@gmail.com" to email field in signup
    And I click on button "Signup"
  ...
  Scenario: User should Place Order: Register while Checkout
    ...
    And I enter payment details "Himanshu Patel" "4261092642672295" "742" "09" and "2027"
  ...
  Scenario: User should place the order successfully : Login before Checkout
    ...
    And I enter "Himanshu324@gmail.com" email and "Himanshu324" password for login
  ...
  Scenario: Verify address details in checkout page
    ...
    And I should see the welcome text on shopping cart page "Shopping Cart"
    And I click on Proceed to Checkout button
    Then I should see the delivery address is same address filled at the time registration of account "Jawahar Nagar"
    And I should see billing address is same address filled at the time registration of account "Jawahar Nagar"
    And I click on header menu option "Delete Account"
    Then I should see the account deleted message "ACCOUNT DELETED!"
    And I click on continue button after deleting account
